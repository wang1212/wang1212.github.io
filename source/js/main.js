$(function() {
	...
	$('body')
		...
		.append($('<footer class="page-footer"><div class="container"><div class="row"><div class="col-sm-2 offset-sm-2 text-xs-center"><img class = "rounded img-responsive" src="/source/images/head.jpg" alt="head" /></div><div class="col-sm-4 text-xs-center"><p class="lead">越努力，越幸运！</p><p>Mr.Wang（不如怀念）</p><p>E-mail：wangyuan230@163.com</p></div></div></div></footer>'))
